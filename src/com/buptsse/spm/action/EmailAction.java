...
import com.buptsse.spm.service.impl.UserServiceImpl;
...
public class EmailAction extends ActionSupport{
	...
	public String emailNotify() throws Exception{
		...
		emailTo = "";
		emailFrom = "shenjialiang163@163.com";
		password = "shenjialiang163";
		...
		try {
			for (int i = 0; i < stuIdArray.length; i++) {
				...
				//System.out.print("--------------test---------:" + course.getEmail());
				//User user = userService.findUser(stuIdArray[i]);
	...
	throws Exception {
        ...
        //mail设置
     	...
     	String strFrom = new String(emailFrom.getBytes(), "UTF-8");
